...
/**
 * IAstVisitor is a visitor over all of the token types. As with ITokenVisitor,
 * we're visiting over POJOs with final fields (except Cons), so we're just
 * going to rebound and pass the objects back to the appropriate methods of the
 * visitor.
 *
