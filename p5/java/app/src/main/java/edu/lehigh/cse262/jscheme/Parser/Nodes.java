...
public class Nodes {
    /**
     * AstNode is the base class for all of the nodes in our abstract syntax tree.
     * Even though AstNode doesn't have any local fields, we define it as an
     * abstract class, so that the AST infrastructure is symmetric with the Token
     * infrastructure.
     */
    public static abstract class BaseNode {
        /**
         * Visit the AstNode to produce a String. This is useful for visitors who
         * want to print the AST for debugging.
         *
    ...
    /**
     * BuiltInFunc is a built-in function that can be executed. It is a first-class
     * value.
     */
    public static class BuiltInFunc extends BaseNode implements IValue {
        ...
        /**
         * Construct a `built in function` from a name and some executable Java code
         */
